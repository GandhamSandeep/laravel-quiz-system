...
<head>
    ...
    <title>Admin Catrogry page</title>
...
<body>
    ...
    <div class=" bg-gray-100 flex flex-col items-center min-h-screen pt-5">
        <div class="bg-white p-8 rounded-2xl shadow-lg w-full max-w-sm">
            ...
            @csrf
                <div>
                    <input name="category" type="text" placeholder="Enter Category Name" class="w-full px-4 py-2 border border-gray-300 rounded-xl focus:outline-none">
                    @error('category')
